...
describe('render', () => {
    describe('word has not been guessed', () => {
        ...
        test('renders component without error', () => {
            const component = findByTestAttr(wrapper, "conponent-input");
...
describe('`guessWord` action creator', () => {
            ...
            test('calls `guessWord` with input value as argument', () => {
                const guessWordArg = guessWordMock.mock.calls[0][0];  //the first element of the first array, which is the last guessed word
        ...
        describe('`guessWord` action creator call', () => {
            ...
            beforeEach(() => {
                ...
                //set up app component with guessWordMock as the guessWord props
                wrapper = shallow(<UnconnectedInput {...props} />);
